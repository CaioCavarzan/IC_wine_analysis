...
## Exibindo a base de dados na tela da base com 2 atributo ##
X_modelo1 = df.drop(columns=['magnesium', 'proanthocyanins', 'proline', 'hue', 'color_intensity', 'nonflavanoid_phenols', 'alcalinity_of_ash', 'malic_acid', 'total_phenols', 'alcohol', 'ash'])
print("\n Wine Data: ")
print(X_modelo1)
## Classificando o 'target' e exibindo as classes da base com 2 atributo ##
print("\nClassificação Alvo (0,1,2): ")
y = wine.target
print(y)
## Exibindo a quantidade de instâncias e de variáveis da base com 2 atributo ##
print('\nVariáveis independentes:', X_modelo1.shape)
print('Variáveis alvo (target)', y.shape)

## Fazendo o Split da base de treino e da base de teste com 2 atributo ##
...
print("\n---------------------------")
print("\nValores Random Forest modelo 1:", list_modelo1)
print("\n---------------------------\n")


print("\nO valor médio da Random Forest com os atributos od280/od315_of_diluted_wines e flavanoids é:", mean(list_modelo1))
